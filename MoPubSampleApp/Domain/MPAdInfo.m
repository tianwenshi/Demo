...
+ (NSArray *)bannerAds
{
    ...
    [ads addObjectsFromArray:@[
                               [MPAdInfo infoWithTitle:@"HTML Banner Ad" ID:@"8d1ec8cffe3448fd8a14b290524766f8" type:MPAdInfoBanner],
...
{
    return @[
             [MPAdInfo infoWithTitle:@"HTML Interstitial Ad" ID:@"b52284767a624fc28232c662bf6c2bb9" type:MPAdInfoInterstitial],
...
{
    return @[
             [MPAdInfo infoWithTitle:@"Rewarded Video Ad" ID:@"75c45fc6b42a4f918af2938ba0a58da5" type:MPAdInfoRewardedVideo],
...
{
    return @[
             [MPAdInfo infoWithTitle:@"Native Ad" ID:@"3f43e6a8600241398ac0aef4661ecf12" type:MPAdInfoNative],
